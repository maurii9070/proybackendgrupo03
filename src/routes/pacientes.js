...
const registrarPacienteValidaciones = [
  ...
  body('email')
    .optional() // El email es opcional, pero si se proporciona, debe ser válido
...
router.post('/registro', registrarPacienteValidaciones, handleInputErrors, registrarPaciente);
